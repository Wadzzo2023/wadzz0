...
const ClaimPage = () => {
    ...
    return (
        <div className="container mx-auto py-10 px-4 bg-base-200 h-screen">
            <h1 className="text-3xl font-bold mb-6">Reward Claims</h1>
            <Tabs defaultValue="redeem" className="w-full max-w-3xl mx-auto">
                ...
                <TabsContent value="redeem">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Enter your redeem code to claim your reward</CardDescription>
                        </CardHeader>
                        <form onSubmit={handleSubmit}>
                            ...
                            <CardFooter>
                                <Button className="w-full" type="submit" disabled={claimMutation.isLoading}>
                                    {
                                        loading && (
                                            <div role="status">
                ...
                <TabsContent value="history">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>View all the rewards you{"'ve"} claimed</CardDescription>
                        </CardHeader>
                        <CardContent>
