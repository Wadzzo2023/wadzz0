          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                {addrShort(transaction.source_account,5)}
                <Button
                  variant="ghost"
                  size="icon"
              ...
              <div>
                ...
                <span className="ml-2">{transaction.source_account_sequence}</span>
              </div>
              <div>
            ...
            <div className="space-y-2">
              <div>
                ...
                <span className="ml-2">{transaction.created_at}</span>
              </div>
              <div>
                <span className="text-sm font-medium">Max Fee:</span>
                <span className="ml-2">{transaction.max_fee} XLM</span>
              </div>
              <div>
