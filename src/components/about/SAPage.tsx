...
import { type SAPageProps } from "./interfaces";
...
const SAPage = (props: SAPageProps) => {
  ...
  return (
    <div className="mx-2 flex flex-col items-center tracking-wider sm:mx-5 lg:mx-10 xl:mx-10">
      <Image
        blurDataURL={props.app.logo.blurDataUrl ?? undefined}
        placeholder={props.app.logo.blurDataUrl ? "blur" : "empty"}
      ...
      >
        <div className="collapse-content w-full max-w-xl">
          <div className="scrollbar-style max-h-96 overflow-y-auto">
            <div className="mx-2 mb-3 mt-2 flex flex-col justify-center rounded-xl bg-base-content/70 ring-2 ring-blue-500/10">
